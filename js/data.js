...
const DEFAULT_APPLICATION_TYPES = [
  ...
  },
  {
    ...
    requirements: [
      ...
      'Proof of valid Food Handlers Training / Seminar conducted by MHO-Ensan Unit or other related agency or institution',
      'X-ray (valid for 6 months)', 
      'CBC (valid for 3 months)', 
      'Urinalysis (valid for 3 months)', 
      'Fecalysis (valid for 3 months)', 
      'Hepa-A (valid for 3 months)',
      'Note: All result with abnormal laboratory findings shall be referred a physician for appropriate treatment.',
      'Deworming',
    ...
    files: [
      ...
      },
      {
        ...
        required: true,
        note: 'X-ray is valid for 6 months; CBC, Urinalysis, Fecalysis, and Hepa-A are valid for 3 months. All abnormal laboratory findings shall be referred to a physician for appropriate treatment.',
      },
      {
        name: 'deworming',
        label: 'Deworming',
